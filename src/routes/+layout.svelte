<script lang="ts">
  ...
  import duggup_logo from "$lib/assets/logos/duggup_logo_with_name.svg";
  import homeIcon from "$lib/assets/icons/nav_home.svg";
  import exploreIcon from "$lib/assets/icons/nav_explore.svg";
  import learnIcon from "$lib/assets/icons/nav_learn.svg";
